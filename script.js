...
function update(localion) {
    monsterStats.style.display = "none";
    button1.innerText = localion["button text"][0];
    button2.innerText = localion["button text"][1];
    button3.innerText = localion["button text"][2];
    button1.onclick = localion["button functions"][0];
    button2.onclick = localion["button functions"][1];
    button3.onclick = localion["button functions"][2];
    text.innerText = localion.text;
}
...
function pick(guess) {
    ...
    text.innerText = "You picked " + guess + ". The numbers were:\n";
